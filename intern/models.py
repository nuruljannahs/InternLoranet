...
class InternInfo(models.Model):
    ...
    intern_address = models.CharField(max_length=255, blank=True, null=True)
    intern_phone = models.CharField(max_length=20, blank=True, null=True)
